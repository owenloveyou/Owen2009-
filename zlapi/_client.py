...
class ZaloAPI(object):
	...
	def _listen_req(self, thread=False, reconnect=5):
			...
			if self.run_forever:
				while not self._listening:
					try:
						...
						self._listen_req(thread, reconnect)
					except:
						pass
	...
	def startListening(self, thread=False, type="websocket", reconnect=5):
	...
	def listen(self, thread=False, type="websocket", run_forever=False, reconnect=5):
		...
		self.startListening(thread, type, reconnect)
	...
	def onLoggingIn(self, phone=None):
		...
		"""
		logger.debug("\033[1;32mLogin {}...".format(phone))
	...
	def onLoggedIn(self, phone=None):
		...
		Args:
			phone: The phone number of the client
		"""
		logger.login("\033[1;36mLogin Whith Phone {} Successful.".format(phone))
	
	def onListening(self):
		"""Called when the client is listening."""
		logger.debug("\033[1;35mDuong Ngoc - Bot Success - Listening...")
